...
public class ZombieSimulatorBootstrap {
    ...
    private static void NewGame()
    {
        ...
        entityManager.SetComponentData(firstHuman, new Heading2D { Value = new float2(0.0f, 0.0f) });
    ...
    private static void DefineArchetypes(EntityManager entityManager)
    {
        ...
        HumanArchetype = entityManager.CreateArchetype(typeof(Heading2D), typeof(Position2D), typeof(TransformMatrix));
